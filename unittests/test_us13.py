...
class TestUS13(unittest.TestCase):
    ...
    def test_sibling_spacings_twins_too_far(self):
        ...
        self.assertEqual(output, "Error: " + str(self.individuals[0]) + " and " + str(
            self.individuals[6]) + " are less than 8 months and more than 2 days apart.\n")
    ...
    def test_sibling_spacings_too_close(self):
        ...
        result, output = Checks.sibling_spacings(
            self.individuals, self.families)
        self.assertEqual(result, False)
        self.assertEqual(output, "Error: " + str(self.individuals[3]) + " and " + str(
            self.individuals[8]) + " are less than 8 months and more than 2 days apart.\n")
